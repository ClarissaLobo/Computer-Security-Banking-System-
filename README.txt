...
----------------------------------------------
RSA Algorithm
-In my banking Project I have used RSA encryption and decryption for exchanging a symmetric key securely between the bank server and ATM client.
...
---------------------------
Step-1: Execute the Bank.py program to start the bank server first using the command: python3 Bank.py <server_port> (---- is my port number)
